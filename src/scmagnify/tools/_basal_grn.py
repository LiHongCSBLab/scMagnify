...
from scmagnify.utils import _get_data_modal, _str_to_list, _matrix_to_edge, _edge_to_matrix
...
def chromatin_constraint(
    ...
    data.uns["motif_scan"]["motif_score"]["motif2factors"] = [_str_to_list(x) for x in filtered_motif_score["motif2factors"]]
